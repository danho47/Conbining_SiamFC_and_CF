...
class Staple(BaseCF):
    def __init__(self):
        ...
        config = staple_config.StapleConfig()
    ...
    def update(self, current_frame, vis=False):
        ...
        #print(self._center)
        #print(im_patch_pwp.shape)
        #print(im_patch_cf.shape)
        ...
        #print(response_cf.shape)
        #response_cf = 0.5 * response_cf + 0.5 * siam
        #print(response_cf.shape)
        ...
        #print('response_pwp : ',response_pwp.shape)

        response = (1 - self.merge_factor) * response_cf + self.merge_factor * response_pwp
        #response = 0.4 * response_cf + 0.2 * response_pwp + 0.4 * siam
